do
  local _ENV = _ENV
  package.preload["crypto.aes_gcm"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.bignum"] = function(...)
    local arg = _G.arg
    ...
    function bignum.is_accelerated()
      ...
      if openssl == nil then
        return false,
          openssl_wrapper.unavailable_reason(openssl_wrapper.Feature.BN)
            or "OpenSSL modular exponentiation is unavailable"
      end
...
do
  local _ENV = _ENV
  package.preload["crypto.blake2"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.chacha20"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.chacha20_poly1305"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.ed25519"] = function(...)
    local arg = _G.arg
    ...
    function ed25519.selftest()
      local function test_vectors_suite()
        ...
        for i, test in ipairs(test_vectors) do
          ...
          checks[1] =
            { name = "derive_public_key", ok = derived == test.public_key, got = derived, want = test.public_key }
        ...
        local cases = {
          ...
          },
          {
            ...
            test = function()
              local seed = ed25519.generate_private_key()
              assert(
                ed25519.derive_public_key(seed) == ed25519.derive_public_key(seed),
          ...
          },
          {
            ...
            test = function()
              ...
              assert(
                ed25519.verify(v.public_key, v.message, v.signature .. "\0") == false,
                "Long signature is rejected"
              )
            end,
          },
          {
            ...
            test = function()
              ...
              assert(
                ed25519.verify(v.public_key .. "\0", v.message, v.signature) == false,
                "Long public key is rejected"
              )
            end,
          },
          {
...
do
  local _ENV = _ENV
  package.preload["crypto.hkdf"] = function(...)
    local arg = _G.arg
    --- @module "crypto.hkdf"
    ...
    function hkdf.selftest()
      ...
      check("distinct info yields distinct output from one PRK", function()
        ...
        return hkdf.expand("sha512", prk, "ClientEncrypt-main", 32)
          ~= hkdf.expand("sha512", prk, "ServerEncrypt-main", 32)
      end)
...
do
  local _ENV = _ENV
  package.preload["crypto.openssl_wrapper"] = function(...)
    local arg = _G.arg
      ...
      local tests = {
        ...
        },
        {
          ...
          test = function()
            ...
            return openssl_wrapper.get(OpenSSLFeature.BN) == nil
              and openssl_wrapper.get_ungated(OpenSSLFeature.BN) ~= nil
          end,
        },
        {
...
do
  local _ENV = _ENV
  package.preload["crypto.poly1305"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.random"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.sha256"] = function(...)
    local arg = _G.arg
    ...
    local function sha256_chunk(chunk, H)
      ...
      for i = 17, 64 do
        ...
        local w2 = W[i - 2]
        local s0 =
          bit32_raw_bxor(bit32_raw_ror(w15, 7), bit32_raw_bxor(bit32_raw_ror(w15, 18), bit32_raw_rshift(w15, 3)))
        local s1 =
          bit32_raw_bxor(bit32_raw_ror(w2, 17), bit32_raw_bxor(bit32_raw_ror(w2, 19), bit32_raw_rshift(w2, 10)))
...
do
  local _ENV = _ENV
  package.preload["crypto.sha512"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.srp"] = function(...)
    local arg = _G.arg
    --- @module "crypto.srp"
...
do
  local _ENV = _ENV
  package.preload["crypto.utils"] = function(...)
    local arg = _G.arg
    --- @module "crypto.utils"
...
do
  local _ENV = _ENV
  package.preload["crypto.utils.benchmark"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.utils.bytes"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.x25519"] = function(...)
    local arg = _G.arg
...
do
  local _ENV = _ENV
  package.preload["crypto.x448"] = function(...)
    local arg = _G.arg
    --- @module "crypto.x448"
