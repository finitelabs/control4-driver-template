do
local _ENV = _ENV
package.preload[ "bthome.const" ] = function( ... ) local arg = _G.arg;
--- @module "bthome.const"
...
do
local _ENV = _ENV
package.preload[ "bthome.crypto" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "bthome.crypto.aes_ccm" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "bthome.event" ] = function( ... ) local arg = _G.arg;
--- @module "bthome.event"
...
do
local _ENV = _ENV
package.preload[ "bthome.parser" ] = function( ... ) local arg = _G.arg;
